...
| views.py (notifications) | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/adamgilroy22/tribe/main/notifications/views.py) | ![screenshot](documentation/testing/py-validation-notifications-tags.png) | Pass: No Errors |
| notification_tags.py (notifications) | [CI PEP8](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/adamgilroy22/tribe/main/notifications/templatetags/notification_tags.py) | ![screenshot](documentation/testing/py-validation-notifications-views.png) | Pass: No Errors |
